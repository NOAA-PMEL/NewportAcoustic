/**********************************************************************************************\
Micro MPC Header file of MPC3.3 Revision. 
Attempting make flawless switching of programs between MPC and uMPC
2.7.2017 AT
/**********************************************************************************************/
#include <stdio.h>
//#include <PLATFORM.h>
...
//#if uMPC
//COM 5  IRQ5 Pin Controls and Baud rate for comms connection
#define 	PAMPWR		24
#define  PAMZEROBIT	29
#define 	PAMONEBIT   30
#define  PAMRESET  	42
#define  PAMSET		37
#define	PAMRX			28
#define  PAMTX			27
#define  PAMBAUD     9600L

//COM 4
#define  IRIDBAUD    	19200L
#define	IRIDGPSPWR		22
#define  IRIDGPSRX      26
#define  IRIDGPSTX      25
...
/*Check_Timers:
	...
	@return: Returns the system power logging interval time. 51.2 seconds if BITSHIFT is defined as 11 in ADS.h
	*/
...
/*Delay_AD_Log:
	@Param1: Short value, number of seconds for delay while watching Power Logging & Tickling Watch Dog Timer
	*/
...
/*ParseStartupParams:
	@Param1: Boolean: True if we use default.cfg as the main startup script.
							False if we use the new system.cfg file received from iridium.
