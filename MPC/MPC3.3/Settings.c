...
Settings SYSSettings[]=
   {
   PROG_NAME,           PROG_DEFAULT,              PROG_DESC,     "",
	PROJID_NAME,	      PROJID_DEFAULT,		      PROJID_DESC,	"",
	PLTFRMID_NAME,	      PLTFRMID_DEFAULT,	         PLTFRMID_DESC,	"",
	LATITUDE_NAME, 		LATITUDE_DEFAULT, 			LATITUDE_DESC,	 "",
	LONGITUDE_NAME, 		LONGITUDE_DEFAULT, 			LONGITUDE_DESC, 	"",
	STARTUPS_NAME,		   STARTUPS_DEFAULT,		      STARTUPS_DESC,		"",
	STARTMAX_NAME,		   STARTMAX_DEFAULT,		      STARTMAX_DESC,		"",	
	MINSYSVOLT_NAME,	   MINSYSVOLT_DEFAULT,	      MINSYSVOLT_DESC,	"",
	FILENUM_NAME,        FILENUM_DEFAULT,           FILENUM_DESC,  "", 
	BATTERYCAPACITY_NAME,BATTERYCAPACITY_DEFAULT,   BATTERYCAPACITY_DESC,"",
	DETECTIONINT_NAME,   DETECTIONINT_DEFAULT,      DETECTIONINT_DESC, "",
	DATAXINTERVAL_NAME,	DATAXINTERVAL_DEFAULT,	   DATAXINTERVAL_DESC,	"",
	DETECTIONINT_NAME,   DETECTIONINT_DEFAULT,      DETECTIONINT_DESC,   "",
	BATTERYLOGGER_NAME,    BATTERYLOGGER_DEFAULT,       BATTERYLOGGER_DESC,    "",
	0, 0, 0, 0
   };
#ifdef POWERLOGGING
...
/*	CTDSAMPLINGMODE_NAME,CTDSAMPLINGMODE_DEFAULT, 	CTDSAMPLINGMODE_DESC, "",
	CTDSAMPLEDELAY_NAME, CTDSAMPLEDELAY_DEFAULT, 	CTDSAMPLEDELAY_DESC, "",
	CTDSAMPLEINTERVAL_NAME, CTDSAMPLEINTERVAL_DEFAULT, CTDSAMPLEINTERVAL_DESC, "",*/
	0, 0, 0, 0
	};
#endif	
...
Settings WISPSettings[]=
   {
	WISPRNUM_NAME,       WISPRNUM_DEFAULT,          WISPRNUM_DESC,       "",
	DETECTIONMAX_NAME,   DETECTIONMAX_DEFAULT,      DETECTIONMAX_DESC,   "",
	
	DETECTIONNUM_NAME,   DETECTIONNUM_DEFAULT,      DETECTIONNUM_DESC,   "",
	WISPRGAIN_NAME,      WISPRGAIN_DEFAULT,         WISPRGAIN_DESC,      "",
	DUTYCYCLE_NAME,      DUTYCYCLE_DEFAULT,         DUTYCYCLE_DESC,      "",
	0, 0, 0, 0
   };   
#endif
#ifdef IRIDIUM   
Settings IRIDSettings[]=
   {
	ANTSW_NAME,	         ANTSW_DEFAULT,		         ANTSW_DESC,	"",
	IRIDPHONE_NAME,	   IRIDPHONE_DEFAULT,	      IRIDPHONE_DESC,	"",
	WARMUP_NAME,	      WARMUP_DEFAULT,	         WARMUP_DESC,	"",
	MAXUPLOAD_NAME,	   MAXUPLOAD_DEFAULT,	      MAXUPLOAD_DESC,	"",
   IRIDREST_NAME,       IRIDREST_DEFAULT,          IRIDREST_DESC,      "", 
   OFFSET_NAME,         OFFSET_DEFAULT,            OFFSET_DESC,      "", 
	MAXCALLS_NAME,       MAXCALLS_DEFAULT,          MAXCALLS_DESC,    "",
	MINSIGQ_NAME,        MINSIGQ_DEFAULT,           MINSIGQ_DESC,     "",
	CALLHOUR_NAME, 		CALLHOUR_DEFAULT, 			CALLHOUR_DESC,		"",
	CALLMODE_NAME, 		CALLMODE_DEFAULT, 			CALLMODE_DESC, 	"",
	0, 0, 0, 0
   };
#endif
#ifdef SEAGLIDER
Settings SEAGSettings[]=
   {
   POWERONDEPTH_NAME,   POWERONDEPTH_DEFAULT,      POWERONDEPTH_DESC, "",
   POWEROFFDEPTH_NAME,  POWEROFFDEPTH_DEFAULT,     POWEROFFDEPTH_DESC, "",
   DIVENUM_NAME,        DIVENUM_DEFAULT,           DIVENUM_DESC,     "",
   0, 0, 0, 0
   };
#endif

#ifdef ACOUSTICMODEM
Settings AMDMSettings[]=
   {
   AMODEMMAXUPLOAD_NAME, AMODEMMAXUPLOAD_DEFAULT, AMODEMMAXUPLOAD_DESC, "",
   AMODEMOFFSET_NAME,   AMODEMOFFSET_DEFAULT, AMODEMOFFSET_DESC, "",
   AMODEMBLOCKSIZE_NAME,  AMODEMBLOCKSIZE_DEFAULT, AMODEMBLOCKSIZE_DESC, "",
   0, 0, 0, 0
   };
...
Settings BTSettings[]=
   {
   BLUETOOTH_NAME, BLUETOOTH_DEFAULT, BLUETOOTH_DESC, "",
   0,0,0,0
   };
#endif
#ifdef WINCH
Settings NIGKSettings[]=
	{
	NIGKDELAY_NAME, NIGKDELAY_DEFAULT, NIGKDELAY_DESC, "",
	NIGKFALLRATE_NAME, NIGKFALLRATE_DEFAULT, NIGKFALLRATE_DESC, "",
	NIGKRISERATE_NAME, NIGKRISERATE_DEFAULT, NIGKRISERATE_DESC, "",
	NIGKANTENNALENGTH_NAME, NIGKANTENNALENGTH_DEFAULT, NIGKANTENNALENGTH_DESC, "",
	NIGKTARGETDEPTH_NAME, NIGKTARGETDEPTH_DEFAULT, NIGKTARGETDEPTH_DESC, "",
	NIGKPROFILES_NAME, NIGKPROFILES_DEFAULT, NIGKPROFILES_DESC, "",
	NIGKRECOVERY_NAME, NIGKRECOVERY_DEFAULT, NIGKRECOVERY_DESC, "",
	0, 0, 0, 0
	};
#endif
...
//	PROMPT			HANDLER					2COLS DEF  CR  ABV	HEADER TEXT
	"SETUP>"		, PDCCmdStdInteractive,		0,	0,	1,	1,	"MPC System Settings Commands\n"
	...
	,"BREAK"       , PDCCmdStdBreak,       0, 0, 0, 0, "Return to Program"
...
CmdTable		SystemCmdTable[] = 
	{
//	PROMPT			HANDLER					2COLS DEF  CR  ABV	HEADER TEXT
	"SYSTEM>"	, PDCCmdStdInteractive,	0,	0,	1,	1,	"System Diagnostic Commands\n"
	,"LIST"			, SetupListCmd,		0,	0,	0,	0,	"List settings [/V] (verbose)"	
	,"SET"			, PDCSetCmd,			0,	0,	0,	0,	"[var=[str]] [/SLFE?]"
	,"GETSET"		, GetSettings, 		0, 0, 0, 0, "get all veeprom settings"
#ifdef ACOUSTICMODEM
...
CmdTable		AModemCmdTable[] = 
	{
//	PROMPT			HANDLER					2COLS DEF  CR  ABV	HEADER TEXT
	"AMODEM>"		, PDCCmdStdInteractive,	0,	0,	1,	1,	"Acoustic Modem Command menu\n"
	,"LIST"			, SetupListCmd,			0,	0,	0,	0,	"List settings [/V] (verbose)"	
	,"SET"			, PDCSetCmd,				0,	0,	0,	0,	"[var=[str]] [/SLFE?]"
	,"SYSTEM"		, SystemSettings,		0,	0,	0,	0,	"System Menu"	
	,"SETUP"			, SetupSettings, 		0, 0, 0, 0, "Settings Setup Menu"
	,"BREAK"       , PDCCmdStdBreak,    0, 0, 0, 0, "Return to Program"
	,"QUIT"			, PDCResetCmd,			0,	0,	0,	0,	"QUIT, RES, EXIT all reset the CFX"	
	,"RES"			, PDCResetCmd,			0,	0,	0,	0,	""	
	,"EXIT"			, PDCResetCmd,			0,	0,	0,	0,	""	
...
//	PROMPT			HANDLER					2COLS DEF  CR  ABV	HEADER TEXT
	...
	,"LIST"			, SetupListCmd,		0,	0,	0,	0,	"List settings [/V] (verbose)"	
	,"SET"			, PDCSetCmd,				0,	0,	0,	0,	"[var=[str]] [/SLFE?]"
   ,"GPS"         , PowerOn_GPS,       0, 0, 0, 0, "Gathering GPS Time"
   ,"GETSET"		, GetIRIDIUMSettings,0, 0, 0, 0, "Get IRIDUM Settings"
	,"IRIDGPS"		, IRIDGPS,				0, 0, 0, 0, "Full Test"
//   ,"UPLOAD"		, UploadFiles,			0, 0, 0, 0, "Upload Files"
	,"BREAK"       , PDCCmdStdBreak,    0, 0, 0, 0, "Return to Program"
	,"QUIT"			, PDCResetCmd,			0,	0,	0,	0,	"QUIT, RES, EXIT all reset the CFX"	
	,"RES"			, PDCResetCmd,			0,	0,	0,	0,	""	
	,"EXIT"			, PDCResetCmd,			0,	0,	0,	0,	""	
...
//	PROMPT			HANDLER					2COLS DEF  CR  ABV	HEADER TEXT
	...
	,"SYSTEM"		, SystemSettings,		0,	0,	0,	0,	"System Menu"	
	,"START"			, StartCTDCmd, 		0, 0, 0, 0, "Power On CTD"
	,"TS"				, CTD_Sample, 			0, 0, 0, 0, "CTD_Sample: TS, SAMPLE"
	,"SAMPLE"		, CTD_Sample, 			0, 0, 0, 0, ""
	,"SYNC"			, CTD_SyncMode,		0, 0, 0, 0, "CTD_SyncMode"
	,"SYNCSTOP"		, CTD_SampleBreak, 	0, 0, 0, 0, "CTD_SampleBreak" 
	,"STOP"			, StopCTDCmd, 			0, 0, 0, 0, "Power Down CTD"
	,"BREAK"       , PDCCmdStdBreak,    0, 0, 0, 0, "Return to Program"
	,"QUIT"			, PDCResetCmd,			0,	0,	0,	0,	"QUIT, RES, EXIT all reset the CFX"	
	,"RES"			, PDCResetCmd,			0,	0,	0,	0,	""	
	,"EXIT"			, PDCResetCmd,			0,	0,	0,	0,	""	
...
//	PROMPT			HANDLER					2COLS DEF  CR  ABV	HEADER TEXT
	...
	,"SAMPLE" 		, SamplePWR, 			0, 0, 0, 0, "Sample Voltage"
	,"START"			, StartPWRCmd, 		0, 0, 0, 0, "Start AtoD Power Logging"
	,"STOP"			, StopPWRCmd, 			0, 0, 0, 0, "Stop AtoD Power Logging"
	,"BREAK"       , PDCCmdStdBreak,    0, 0, 0, 0, "Return to Program"
	,"QUIT"			, PDCResetCmd,			0,	0,	0,	0,	"QUIT, RES, EXIT all reset the CFX"	
	,"RES"			, PDCResetCmd,			0,	0,	0,	0,	""	
	,"EXIT"			, PDCResetCmd,			0,	0,	0,	0,	""	
...
CmdTable		WISPRCmdTable[] = 
	{
//	PROMPT			HANDLER					2COLS DEF  CR  ABV	HEADER TEXT
	"WISPR>"		, PDCCmdStdInteractive,
												0,	0,	1,	1,	"Power Command Menu\n"
	,"SYSTEM"		, SystemSettings,	0,	0,	0,	0,	"System Menu"	

	,"LIST"			, SetupListCmd,				0,	0,	0,	0,	"List settings [/V] (verbose)"	
	,"SET"			, PDCSetCmd,				0,	0,	0,	0,	"[var=[str]] [/SLFE?]"
	,"GETSET" 		, GetWISPRSettings, 	0, 0, 0, 0, "GetWISPRSettings"
	,"ON"				, WISPROn, 				0, 0, 0, 0, "Start AtoD Power Logging"
	,"OFF"			, WISPROff, 			0, 0, 0, 0, "Stop AtoD Power Logging"
	,"BREAK"       , PDCCmdStdBreak,    0, 0, 0, 0, "Return to Program"
	,"QUIT"			, PDCResetCmd,			0,	0,	0,	0,	"QUIT, RES, EXIT all reset the CFX"	
	,"RES"			, PDCResetCmd,			0,	0,	0,	0,	""	
	,"EXIT"			, PDCResetCmd,			0,	0,	0,	0,	""	
...
void WISPROn(){ OpenTUPort_WISPR(true);WISPRPower(true); }
void WISPROff(){ WISPRPower(false);OpenTUPort_WISPR(false);}
...
void StartPWRCmd(){
	if(!ADS_Status()) Setup_ADS(true, 0L, 8);
}
void StopPWRCmd(){
	...
	printf("\nTime Now: %ld", timenow); cdrain(); coflush();
