...
**       N:    Detection Return Num: The Number of Detections for RAOSBottom to induce an AModem Call
**       G:    WISPR Gain
...
WriteFile (ulong TotalSeconds)
{
  ...
  sprintf (WriteBuffer,
	   "MPC AUH Program Ver:%3.2f\n-SU:%d -SM:%d\n-SFS: %ld\n-WT:%s\n-DT:%lu -DI:%3d\0",
	   PROG_VERSION, MPC.STARTUPS, MPC.STARTMAX, SystemFreeSpace,
	   Time (NULL), TotalSeconds, MPC.DETINT);
