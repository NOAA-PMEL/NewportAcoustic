...
//#define CTDSENSOR
//#define SEAGLIDER
#define REALTIME		//AUH is not transmitting real time data. But the DataXInterval Timer is set for ~1 day periods inwhich filenum will be incremented.
...
#ifdef POWERLOGGING
#define PWR(X) X
 //Crucial to ADS Timing of Program. explained in ads power consumption calcation excel file
#define BITSHIFT 11
#else
#define PWR(X)
#endif
